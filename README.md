...
| `GET`  | `/public/<path>`   | Serves immutable static assets bundled into the image   |
| `GET`  | `/uploads/demo.txt` | Serves the file that simulates a user upload           |
| `GET`  | `/test-rw/uploads` | Reads the simulated upload                              |
| `PUT`  | `/test-rw/uploads` | Writes `content`, or hostname and timestamp by default  |
...
the image, while `/home/appuser/uploads` contains the writable simulated upload.
